  ...
  <div class="container">
    ...
    <div class="articleWrapper">
      <div class="article">
        ...
        <p>На странице «Тренд» мы говорили о том, что цены движутся вверх, вниз или вбок не прямолинейно, а зигзагообразно. Поэтому рост (снижение) цен, как правило, сопровождается так называемыми откатами. Такие откаты еще называют коррекцией тренда. Так вот числа (коэффициенты) Фибоначчи позволяют определить глубину коррекции (отката). Чаще всего при построении подобных линий используются следующие соотношения Фибоначчи: 0.236, 0.382, 0.618, 1, 1,618, 2,61 …, или в виде процентов: 23.6%, 38.2%, 61.8%...</p>
        <p>Торговый терминал MetaTrader предусматривает возможность работы с уровнями Фибоначчи. Уровни накладываются между двумя экстремумами, в зависимости от того, в какую сторону двигалась цена. Если цена повышается, то уровни располагаются от минимума к максимуму и наоборот.</p>
