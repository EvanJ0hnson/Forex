    ...
    <div class="articleWrapper">
      <div class="article">
        ...
        <p>Данная торговая система использует скользящие средние с периодом 13 (СС13) и с периодом 21 (СС21), а также MACD, Parabolic sar и RSI.
          <br/> Алгоритм торговой системы таков:</p>
        <ol>
          <li>Определение тренда на дневном графике</li>
          <li>Определение завершения отката на часовом графике</li>
          <li>Определение точки входа</li>
          <li>Определение точки выхода</li>
        </ol>
        <p><b><i>ПРОБЕЛ</i></b></p>
        ...
        <p>Чтобы определить завершение отката, необходимо для начала выявить на часовом графике тренд, противоречащий тренду на дневном графике, а затем определить момент его завершения. Для этого используем хорошо известные и проверенные временем способы, а именно:</p>
        <ol>
          <li>Пробой ценами линии тренда.</li>
          <li>Дивергенция (расхождения цен с индикаторами).</li>
          <li>Изменение положения Parabolic sar относительно цен и проч.</li>
        </ol>
        <p>&nbsp;</p>
        ...
        <p>На дневном графике нисходящий тренд. На это указывают и <em>линия тренда, и MACD, и Parabolic sar.</em></p>
        <p><b><i>ПРОБЕЛ</i></b></p>
        ...
        <p>На часовом графике хорошо видно, что:</p>
        <ol>
          <li>Цены пробивают СС13 и СС21 сверху вниз;</li>
          <li>RSI пробивает линию 50;</li>
          <li>Цены возвращаются к СС13 и СС21 (вертикальный красный пунктир);</li>
          <li>RSI возвращается к линии 50 (вертикальный красный пунктир);</li>
        </ol>
        <p>&nbsp;</p>
        ...
        <p><strong>Тем более сделку необходимо немедленно закрыть, как только СС13 пересекает СС21 снизу вверх.</strong></p>
